    ...
    var body: some View {
        Form {
            Section("Playback") {
                ...
                .accessibilityHint("Controls how fast episodes play. 1× is normal speed.")
                ...
                .accessibilityHint("How many seconds the skip-back button jumps.")
                ...
                .accessibilityHint("How many seconds the skip-forward button jumps.")

                Toggle("Auto-Play Next", isOn: $preferences.autoPlayNext)
                    .accessibilityHint("Automatically starts the next episode when the current one ends.")
            }

            Section("Audio Enhancement") {
                Toggle("Trim Silence", isOn: $preferences.trimSilence)
                    .accessibilityHint("Speeds up playback by shortening quiet pauses between words.")
                Toggle("Voice Boost", isOn: $preferences.voiceBoost)
                    .accessibilityHint("Applies processing to make voices clearer and more prominent.")
                Picker("Equaliser", selection: $preferences.podcastEQ) {
                    ForEach(PodcastEQ.allCases) { eq in
                        Text(eq.displayName).tag(eq)
                    }
                }
                .accessibilityHint("Adjusts the audio frequency balance.")
            }
            ...
            Section("Smart Controls") {
                ...
                .accessibilityHint("Automatically pauses playback after the chosen period. Useful for falling asleep while listening.")
                ...
                .accessibilityHint("When you resume a paused episode, the player rewinds by this many seconds to give you context.")
            }
            ...
            Section("Downloads") {
                ...
                .accessibilityHint("Automatically downloads new episodes for offline listening.")
