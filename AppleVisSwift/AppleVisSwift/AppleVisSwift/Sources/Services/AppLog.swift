...
enum AppLog {
    static let sync = Logger(subsystem: "com.applevis.app", category: "sync")
    static let auth = Logger(subsystem: "com.applevis.app", category: "auth")
    static let persistence = Logger(subsystem: "com.applevis.app", category: "persistence")
    static let player = Logger(subsystem: "com.applevis.app", category: "player")
    static let intelligence = Logger(subsystem: "com.applevis.app", category: "intelligence")
    ...
    static let network = Logger(subsystem: "com.applevis.app", category: "network")
}
