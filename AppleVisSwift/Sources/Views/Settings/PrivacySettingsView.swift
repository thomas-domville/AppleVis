        ...
        Form {
            ...
            Section("Privacy at a Glance") {
                InfoCard(
                    ...
                    body: "We do not use third-party advertising networks or sell your data to advertisers."
                )
                InfoCard(
                    icon: "icloud.slash",
                    title: "Analytics Are Anonymous",
                    body: "Usage analytics are aggregated and never linked to your account or device identity."
                )
                InfoCard(
                    icon: "lock.icloud",
                    title: "iCloud Sync Is End-to-End",
                    body: "Data synced via iCloud uses Apple's end-to-end encryption. AppleVis cannot read it."
                )
                InfoCard(
                    icon: "cpu",
                    title: "On-Device AI",
                    body: "Smart features powered by AI run on your device using Apple Intelligence. Content is not sent to external servers."
                )
                InfoCard(
                    icon: "envelope.badge.shield.half.filled",
                    title: "Notification Privacy",
                    body: "Push notification content is encrypted in transit. Notification payloads are minimal — we don't embed full article text."
                )
            }
