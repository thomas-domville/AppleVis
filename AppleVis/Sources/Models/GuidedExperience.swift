    ...
    static let welcome = GuidedExperience(
        ...
        steps: [
            ...
            GuidedExperienceStep(
                ...
                body: "Open Home, and depending on your settings, you might hear a short spoken welcome — or even a full rundown of what's new since you were last here. That's Home Startup Behavior, and you can turn it up, down, or off entirely in Settings. You may also spot a short summary of new activity at the top — tap it to jump straight to the first new item, or turn it off separately if you'd rather Home stay visually quiet (it's its own setting, independent of the spoken welcome). Right below that lives a little switcher with three views — All, New, and Mouse Recap — and I'll walk you through exactly what each one shows you next."
            ),
            GuidedExperienceStep(
            ...
            GuidedExperienceStep(
                ...
                body: "That covers Home — the feed, making it yours, all three views, item actions, and every kind of detail page. Ready to see what Discover has to offer, or want to explore Home for real first?",
