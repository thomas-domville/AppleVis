...
export const SETTINGS_SECTIONS: SettingsSection[] = [
  ...
  // ── 9. Help ───────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { id: 'helpBugTracker',     label: 'Bug Tracker Guide',          description: 'How to browse active and resolved accessibility bugs, read full bug reports, file your own Apple report, and submit new bugs to AppleVis.', example: 'Step-by-step: open Discover > Bug Tracker, choose iOS or macOS, read a report, and tap Report to Apple on active bugs.', type: 'nav', status: 'live' },
